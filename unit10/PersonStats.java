...
public class PersonStats
{
  ...
  public static void main(String[] args)
  {
    ...
    persons.add(new Person("Alex", 0));
    persons.add(new Person("Ava", 3));
    persons.add(new Person("Andrew", 2));
    persons.add(new Person("Allison", 1));
    ...
    mostPetsTest(persons, "Ava");

    ArrayList<Person> petlovers = new ArrayList<Person>();
    petlovers.add(new Person("Ava", 3));
    petlovers.add(new Person("Andrew", 2));
